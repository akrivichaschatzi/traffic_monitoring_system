      ...
      <div class="col-xl-12 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <img class="col-lg-6 d-none d-lg-block bg-login-image" style="height:400px;" src="img/background.jpg">
			  
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Traffic Monitoring System</h1>
                  </div>
